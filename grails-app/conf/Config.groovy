...
environments {
    ...
    development {
        grails.serverURL = "http://fa.it2media.de:8080/${appName}"
    }
    test {
...
grails.plugins.springsecurity.userLookup.authorityJoinClassName="info.makmak.UserRole"
grails.plugins.springsecurity.authority.className="info.makmak.Role"
